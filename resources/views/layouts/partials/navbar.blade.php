<header class="sticky-top">
    <nav id="menuHamburguesa" class="navbar navbar-expand-xxxl p-3 text-bg-light">
        <a href="/">
            <img class="logoHome" src="{{ asset('images/World_Taekwondo.webp') }}" alt="logo TKD" width="100px" />
        </a>
        <span class="fs-4 ms-3 tituloPag"> Poomsae Reconocido </span>
        ...
        <div id="botonesBasicos" class="d-flex justify-content-between align-items-center">
            ...
            <div class="boton-container" >
                <a  href="{{ route('verPerfil') }}" class="btn btn-outline-dark">
